  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      if (formData.payment_method === 'card_payment') {
        ...
        const sessionResult = await stripePayment.createCheckoutSession({
          orderId: order.id,
        ...
        if (sessionResult.success && sessionResult.sessionId) {
          ...
          const redirectResult = await stripePayment.redirectToCheckout(sessionResult.sessionId);
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                {!stripePayment.isConfigured() && formData.payment_method === 'card_payment' && (
                  <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <p className="text-sm text-yellow-800">
                      Stripe is not configured. Please add your Stripe keys to proceed with card payments.
                    </p>
                  </div>
                )}
              </CardContent>
